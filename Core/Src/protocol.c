...
void Protocol_HandleCommand(const char *cmd,
	...
	if (strcmp(cmd, "PING") == 0)
	    ...
	    else if (strcmp(cmd, "GET_STATUS") == 0)
	    {
	    	snprintf(response,
	               responseSize,
	               "STATUS:TEMP=%d;HUM=%d;LOAD=%d;VIB_X=%ld mg;VIB_Y=%ld mg;VIB_Z=%ld mg;fanRPM=%ld;emergency_button=%d;STATE=%s;FAULT=%s;OPERATING_MODE=AUTO_MODE;DHT_STATUS=%s;LOAD_STATUS=%s\r\n",
